...
import com.blackangel.baframework.core.base.BaseListActivity;
import com.blackangel.baframework.logger.MyLog;
import com.blackangel.baframework.util.NetworkUtil;
    ...
    public APICallResult doInBackground(JSONObject... params) {
        ...
        try {
            ...
            if (method.equalsIgnoreCase("POST")) {
                ...
                MyLog.w("request " + serverUrl + APIUrl + " POST, jsonParams >> " + json);
                ...
                MyLog.w("request " + serverUrl + APIUrl + " GET");
