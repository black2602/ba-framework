...
import com.blackangel.baframework.media.image.fragment.GalleryFragment;
...
import com.blackangel.baframework.ui.view.imageview.TouchImageView;
...
public class BaseFullScreenImageViewerActivity extends BaseActivity implements PreviewsFragment.PreviewActionListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final int count = getIntent().getIntExtra(IntentConst.KEY_IMAGE_COUNT, 1);
        final int initialImgIdx = getIntent().getIntExtra(IntentConst.KEY_INITIAL_IMAGE_INDEX, 0);
    ...
    public void onClick(View view) {
        MyLog.i("view.id=" + view.getId() + ", view.getTag=" + view.getTag());
...
//        } else
    ...
    public void onBackPressed() {
        ...
        returnIntent.putStringArrayListExtra(IntentConst.KEY_IMAGE_PATH_LIST, mDelImagePathList);
    ...
    public class ZoomImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(final ViewGroup pager, final int position) {
            ...
            MyLog.d("zoom touchimgView width=" + imgView.getWidth() + ", height=" + imgView.getHeight());

            imgView.post(new Runnable() {
                @Override
                public void run() {
//                    ImageAware imageAware = new ImageViewAware(imgView, false);
//                    MyLog.d("zoom touchimgView post width=" + imageAware.getWidth() + ", height=" + imageAware.getHeight());
