package com.blackangel.baframework.media.camera.fragment;
...
import com.blackangel.baframework.content.ContentProviderHelper;
...
import com.blackangel.baframework.media.camera.view.CameraViewCompat;
...
//                mCameraView.setCameraSizeToSquare();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (checkPermission(Manifest.permission.CAMERA) && checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            if(mOpenPublic) {
                mCameraView.setDestFilePath(MyPackageManager.getPublicAppAlbumPath(getContext()));
            } else {
                mCameraView.setDestFilePath(MyPackageManager.getTempImagePath(getContext()));
            }
        }
    }
...
//        ((RegistProductImagesActivity) getActivity()).showGallery();
    ...
    public void takePicture() {
        ...
        MyLog.v("mLockCameraTake=" + mLockCameraTake);
