package com.blackangel.baframework.media.image.util;
...
public class AUILUtil {
    ...
    public static class ImageCacheRefreshLoadingListener extends SimpleImageLoadingListener {
        ...
        public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
            MyLog.e("ImageLoader", "onLoadingComplete(" + imageUri + ", cacheFound=" + cacheFound + ")");
            // 다시 로드
            if (cacheFound) {
                ...
                MyLog.w(ImageLoader.TAG, "캐시 삭제!! > " + imageUri);
