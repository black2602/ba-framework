package com.blackangel.baframework.media.image.view;
...
import com.blackangel.baframework.media.image.ThumbnailDisplayer;
...
public class PreviewView extends RelativeLayout implements View.OnClickListener {
    ...
    public void setImageBitmap(Bitmap bitmap) {
        MyLog.d("thumbnail setImageBitmap="+ this.toString());
