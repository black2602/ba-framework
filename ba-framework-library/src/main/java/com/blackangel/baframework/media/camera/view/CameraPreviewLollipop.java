...
//            mCaptureSession.capture()
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        MyLog.i("initedPreview=" + initedPreview + ", width=" + width + ", height=" + height + ", isFrontCamera=" + isFrontCamera);
        MyLog.i("mPreviewSize=" + mPreviewSize);
...
//        MyLog.i("width=" + width + ", height=" + height + ", initedPreview=" + initedPreview);
//        if (width < 0 || height < 0) {
...
//        MyLog.i("widthMeasureSpec=" + widthMeasureSpec + ", heightMeasureSpec=" + heightMeasureSpec);
//
...
//        MyLog.i("w=" + w + ", h=" + h + ", oldw=" + oldw + ", oldh=" + oldh);
//        mCurViewSizeRatio = getHeight() / (float) getWidth();
//
//        MyLog.d("camera view size=" + getWidth() + " x " + getHeight() + " , ratio >> 1 : " + mCurViewSizeRatio + ", initedPreview=" + initedPreview);
//
//        if(!initedPreview) {
//            return;
//        }
...
//    }
    ...
    private Size getBestPreviewResize(int width, int height, CameraCharacteristics characteristics) {
        ...
        MyLog.d("displayRotation=" + displayRotation);
        ...
        for(Size size : map.getOutputSizes(SurfaceHolder.class)) {
            ...
            MyLog.d("viewSizeRatio=" + viewSizeRatio + ", size=" + size + ", ratio=" + ratio);
        ...
        if(contenderSizeList.size() > 0) {
            ...
            for (Size size : contenderSizeList) {
                MyLog.d("sorted contenderSizeList size=" + size);
        ...
        MyLog.d("bestSize width=" + bestSize.getWidth() + ", height=" + bestSize.getHeight());
    ...
    public void openCameraAfterViewCreated() {
        MyLog.i("isFrontCamear=" + isFrontCamera);
...
//        }
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(@NonNull CameraDevice cameraDevice) {
            ...
            MyLog.i("cameraId=" + cameraDevice.getId());
            mCameraOpenCloseLock.release();
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            MyLog.i("cameraDeviceId=" + cameraDevice.getId() + ", error=" + error);
            mCameraOpenCloseLock.release();
            cameraDevice.close();
            mCameraDevice = null;
            Activity activity = (Activity) getContext();
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                MyLog.d("frontCamera=" + frontCamera);
                //TODO 제거
//                for(Size size : map.getOutputSizes(SurfaceHolder.class)) {
//                    MyLog.d("available preview size=" + size.toString() + " , ratio >> 1 : " + size.getWidth() / (float) size.getHeight());
//                }
                mPreviewSize = chooseOptimalSize(map.getOutputSizes(SurfaceHolder.class),
                        rotatedPreviewWidth, rotatedPreviewHeight, maxPreviewWidth,
                        maxPreviewHeight, mLargestPictureSize);

                MyLog.d("mPreviewSize width=" + mPreviewSize.getWidth() + ", height=" + mPreviewSize.getHeight());
...
//                }
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            MyLog.i(TAG, "찍은 사진 크기 width=" + takenPictureImage.getWidth() + ", height=" + takenPictureImage.getWidth());
                ...
                new Handler(getContext().getMainLooper()) {
                    ...
                    public void handleMessage(Message msg) {
                        if(msg.what == 0) {
                            ...
                            MyLog.d("result.getFilepath()=" + result.getFilepath());
...
//                    MyLog.v("state = STATE_PREVIEW");
                    break;
                }
                case STATE_WAITING_LOCK: {
                    Integer afState = result.get(CaptureResult.CONTROL_AF_STATE);
                    MyLog.v("state = STATE_WAITING_LOCK, afState=" + afState);
                    if (afState == null) {
                        captureStillPicture();
                    } else if (CaptureResult.CONTROL_AF_STATE_FOCUSED_LOCKED == afState || CaptureResult.CONTROL_AF_STATE_NOT_FOCUSED_LOCKED == afState) {
                        // CONTROL_AE_STATE can be null on some devices
                        Integer aeState = result.get(CaptureResult.CONTROL_AE_STATE);
                        MyLog.v("state = STATE_WAITING_LOCK, aeState=" + aeState);
                ...
                case STATE_WAITING_PRECAPTURE: {
                    // CONTROL_AE_STATE can be null on some devices
                    Integer aeState = result.get(CaptureResult.CONTROL_AE_STATE);
                    MyLog.v("state = STATE_WAITING_PRECAPTURE, aeState=" + aeState);
                    if (aeState == null ||
                ...
                case STATE_WAITING_NON_PRECAPTURE: {
                    // CONTROL_AE_STATE can be null on some devices
                    Integer aeState = result.get(CaptureResult.CONTROL_AE_STATE);
                    MyLog.v("state = STATE_WAITING_NON_PRECAPTURE, aeState=" + aeState);
...
//            captureBuilder.set(CaptureRequest.JPEG_ORIENTATION, getOrientation(rotation));
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback = new CameraCaptureSession.CaptureCallback() {
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                    ...
                    MyLog.d("taken picture orientation=" + takenPicOrientation);
    ...
    private int getJpegOrientation(CameraCharacteristics c, int deviceOrientation) {
        ...
        MyLog.d("jpegOrientation=" + jpegOrientation);
    ...
    private void setFlash(CaptureRequest.Builder requestBuilder) {
        MyLog.d("mFlashSupported=" + mFlashSupported + ", flashMode=" + flashMode);
        if (mFlashSupported) {
    ...
    private int getOrientation(int rotation) {
        ...
        MyLog.d("ORIENTATIONS.get(rotation)=" + ORIENTATIONS.get(rotation) + ", mSensorOrientation=" + mSensorOrientation);
