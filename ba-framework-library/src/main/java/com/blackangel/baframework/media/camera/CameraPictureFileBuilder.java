package com.blackangel.baframework.media.camera;
...
//                outputWidth = (int) (bmp.getWidth() * (1.0f - mCropRatio));
        ...
        MyLog.d("origin bitmap size=" + bmp.getWidth() + " x " + bmp.getHeight());
        MyLog.d("crop bitmap size=" + outputWidth + " x " + outputHeight);
        ...
        MyLog.d("final bitmap size=" + finalBitmap.getWidth() + " x " + finalBitmap.getHeight());
        ...
        try {
            ...
            MyLog.d(TAG, "IMAGE TEST >> camera taken picture save success!!");
    ...
    private float getRatio(Point cropSize) {
        MyLog.i("cropSize=" + cropSize.toString());
        float ratio;
    ...
    public class BuildImageResult {
        ...
        public String getFilename() {
            ...
            MyLog.d("originImagePath=" + mFilepath + ", filename=" + filename);
            return filename;
        }
