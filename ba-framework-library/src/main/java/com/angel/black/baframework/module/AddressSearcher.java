package com.angel.black.baframework.module;
...
import com.angel.black.baframework.ui.dialog.custom.DefaultDialogCustomViewInflater;
...
import com.angel.black.baframework.ui.view.recyclerview.SimpleLineDividerItemDecoration;
import com.angel.black.baframework.util.ScreenUtil;
import com.angel.black.baframework.util.ViewUtil;
...
public class AddressSearcher {
    ...
    public void showDialogSearchAddress(final OnAddressSelectedListener onAddressSelectedListener) {
        DialogItems dialogItems = new DialogItems.Builder(mActivity)
                ...
                .setCustomViewInflater(new DefaultDialogCustomViewInflater() {
                    @Override
...
//        mActivity.showCustomDialog(dialogItems, TAG_SEARCH_ADDR);
    ...
    public static class AddressSearchFragment extends BaseListFragment implements RecyclerViewAdapterHelper<List<Address>, Address>, View.OnClickListener {
...
//        }
        ...
        public AbsRecyclerViewHolder createViewHolder(ViewGroup parent) {
            ...
            v.setOnClickListener(mOnRowClickListener);
...
//            v.setOnClickListener(this);
        ...
        public void onBindViewHolder(AbsRecyclerViewHolder holder, int position, Address data) {
            ((ViewHolder) holder).mRow.setOnClickListener(mOnRowClickListener);
        ...
        @Override
        public RecyclerViewColletionData<List<Address>, Address> provideData() {
...
//        }
        ...
        public void onClick(View v) {
            ...
            Address addressInfo = (Address) mRecyclerViewAdapter.getDataset().getData(position);

            getBaseActivity().showCustomDialog(makeDialogItemAddressSelect(addressInfo), TAG_SELECT_ADDR);
        }
